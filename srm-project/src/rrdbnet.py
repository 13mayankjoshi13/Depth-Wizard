"""
Self-contained RRDBNet architecture (Real-ESRGAN backbone).
Eliminates hard dependency on basicsr so training and inference can run cleanly
even when basicsr installation is unavailable or conflicting.
"""
import torch
